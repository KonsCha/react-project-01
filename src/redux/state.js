...
let state = {
    ...
    PostsData: [
        {counter: 4, message: "'Hi everyone'", src: 'https://miro.medium.com/max/1200/1*BomiWkQi5XB5A4KpQziJpw.jpeg'},
        {
            counter: 6,
            message: "'I love cats'",
        ...
        },
        {
            ...
            src: 'https://www.wallpaperflare.com/static/269/794/549/puppy-kitten-pair-friendship-wallpaper.jpg'
        }
    ]
};
